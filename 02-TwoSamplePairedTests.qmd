...
1. Visualiser les données brutes avec un **stripchart** :
...
2. Visualiser les données brutes avec des **histogrammes facettés** :
...
3. Visualiser les données brutes avec des **diagrammes de densité facettés** :
...
4. Visualiser les données brutes avec des **boîtes à moustaches** :
